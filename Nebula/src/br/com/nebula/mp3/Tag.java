...
public class Tag {
	...
	public Tag(File f, HashMap<String, String> tags) throws UnsupportedTagException, InvalidDataException, IOException, NotSupportedException {
		//construtor que monta um objeto Tag a partir de um arquivo File, reconstruindo o arquivo no padr�o da aplica��o
		super();
		Mp3File mp3 = new Mp3File(f);
		//ID3v1 v1; //never used
		ID3v2 v2;
	...
	public static Tag getTag(File f) throws UnsupportedTagException, InvalidDataException, IOException{
		//m�todo que retorna um objeto Tag a partir de um arquivo File, sem alterar o arquivo
		Tag t = new Tag();
